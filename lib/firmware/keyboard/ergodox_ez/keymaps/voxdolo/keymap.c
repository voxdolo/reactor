 ...
 * |---------+------+------+------+------+------|Hyper/[|           | Meh/]|------+------+------+------+-------+--------|
 * | LShift  |Z/Ctrl| X/Alt|   C  |   V  |   B  |       |           |      |   N  |   M  |   ,  |./RAlt|//RCtrl|   =    |
 * `---------+------+------+------+------+--------------'           `-------------+------+------+------+-------+--------'
 *   |  WinL | WinR | WinM | Alt  | LGui |                                       |  Bksp | Left |  Up  | Down  | Rght |
 *   `-----------------------------------'                                       `------------------------------------'
 *                                        ,---------------.       ,---------------.
 *                                        |Play/Ps |  L1  |       |  L2  | Next   |
 *                                 ,------|--------|------|       |------+------+------.
 *                                 |      |        | ~L1  |       | ~L2  |      |      |
 *                                 |LShift|Ctrl/Esc|------|       |------| Enter| Spc  |
 *                                 |      |        | Vol- |       | Vol+ |      |      |
 *                                 `----------------------'       `--------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MEH_T(KC_RBRC),KC_N,   KC_M,   KC_COMM,ALT_T(KC_DOT), CTL_T(KC_SLSH),   KC_EQL,
                        KC_BSPC, KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT,
        TG(MDIA),    KC_MNXT,
        MO(MDIA),
